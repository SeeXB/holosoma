...
OUTPUT_ROOT="${OUTPUT_ROOT:-${PROJECT_ROOT}/exp/retargeting/a3_sub3_largebox_003_20260922}"
TASK="sub3_largebox_003"
INPUT_ROOT="${PACKAGE_DIR}/demo_data/omomo/official_inputs"
SCENE="${PACKAGE_DIR}/demo_data/models/a3/a3_31dof_w_largebox.xml"
PLAN="${PACKAGE_DIR}/demo_data/semantic_keyframes/frozen/dynamic_json_intermimic_v6_semantic_b4_no_obj_nonpenetration/omomo/${TASK}/semantic_plan.json"
...
echo "InterMimic input: ${INPUT_ROOT}/${TASK}.pt"
